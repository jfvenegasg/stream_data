...
def connect_tcp_socket() -> sqlalchemy.engine.base.Engine:
    ...
    if os.environ.get("DB_ROOT_CERT"):
        db_root_cert = os.environ["server-ca.pem"]  # e.g. '/path/to/my/server-ca.pem'
        db_cert = os.environ["client-cert.pem"]  # e.g. '/path/to/my/client-cert.pem'
        db_key = os.environ["client-key.pem"]  # e.g. '/path/to/my/client-key.pem'
